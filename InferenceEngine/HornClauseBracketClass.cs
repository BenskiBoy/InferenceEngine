...
{
	// Abstract class to model the behaviour of a bracket Horn Clause
	// E.g. "bracket P1", which means symbol P1 is false.
	public class HornClauseBracketClass : HornClauseClass
	{	
		// Atributes
		...
		// Method to return the premise symbols contained within the bracket Clause
